...
export default function BookingFrom() {
    return (
        <div className="bg-[#111]">
            <div className="max-w-4xl mx-auto  text-gray-300 p-8 rounded-lg shadow-lg ">
                <form className="space-y-6 mt-20">
                    ...
                    <div className="flex justify-center">
                        <button
                            type="submit"
                            className="px-6 py-2 mt-4 bg-teal-600 text-white rounded-md hover:bg-teal-700 transition duration-300"
                        >
                            Send
                        </button>
                    </div>
