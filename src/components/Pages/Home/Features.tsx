        ...
        <div className="w-full container py-16 px-4">
            <div className="flex flex-col">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                    {/* Card 1 */}
                    <div className="flex md:flex-row items-center bg-[#154047] border border-[#627F84] p-6 rounded-[50px] shadow-xl space-x-6">
                        <div className="w-1/3 border-2 border-[#4e817b] rounded-2xl">
                            <Image
                                width={150}
                                height={150}
                                src={pailoat}
                    ...
                    {/* Card 2 */}
                    <div className="flex items-center bg-[#154047] border border-[#627F84] p-6 rounded-[50px] shadow-xl space-x-6">
                        <div className="w-1/3 border-2 border-[#4e817b] rounded-3xl">
                            <Image
                                width={150}
                                height={150}
                    ...
                    {/* Card 3 */}
                    <div className="flex items-center bg-[#154047] border border-[#627F84] p-6 rounded-[50px] shadow-3xl space-x-6">
                        <div className="w-1/3 border-2 border-[#4e817b] rounded-2xl">
                            <Image
                                width={150}
                                height={150}
